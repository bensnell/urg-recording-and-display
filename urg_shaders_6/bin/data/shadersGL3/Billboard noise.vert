...
//    zOffset = pow(zOffset / 10., 3);
    newPosition.y += yOffset * perlinMultiplier / 2.;
    newPosition.x += xOffset * perlinMultiplier / 2.;
    newPosition.z += zOffset * perlinMultiplier / 3.;
    ...
    // POINT OPACITY
    float pointOpacityScale = pow(normalizedDist, pointOpacityPower);
    ...
    vec4 newColor = vec4(color.xyz, newPtOpacity);
