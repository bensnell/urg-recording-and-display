...
void main() {
    ...
    // perlin noise offset
    float xOffset = noise(vec3(position.x / 10000., position.y / 10000., time / 1000. + position.x / 10000.));
    float yOffset = noise(vec3(position.x / 10000. + position.z / 10000., position.y / 10000., time / 1000. + position.y / 10000.));
