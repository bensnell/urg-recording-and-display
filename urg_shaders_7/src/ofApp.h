...
class ofApp : public ofBaseApp {
    ...
    ofVec3f cameraRotation = ofVec3f(0., 0., 270.);
    float zoom = -2000;
    float zoomTarget = -3000;
    float yRotTarget;
    float xTransTarget = 1000;
    ...
    ofVec3f *billboardVels; // is this necessary?
